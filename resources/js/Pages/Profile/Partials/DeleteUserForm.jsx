        ...
        <section className={`space-y-6 ${className}`}>
            <header>
                ...
                <p className="mt-1 text-sm text-gray-600">
                    Al eliminar tu cuenta, también se eliminará toda la información relacionada. Antes de eliminar tu cuenta, por favor respalda toda la información que necesites.
                </p>
            </header>
